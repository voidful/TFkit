...
def main(arg=None):
    ...
    logger = Logger(
        savedir=input_arg.get("savedir"),
        tensorboard=input_arg.get("tensorboard", False),
    ...
    if input_arg.get("add_tokens_freq", None):
        ...
        add_tokens = tok.get_freqK_unk_token(
            tokenizer,
            input_arg.get("train") + input_arg.get("test"),
