...
class TestTrain(unittest.TestCase):
    ...
    def testMultiTask(self):
        ...
        result = os.system(
            "tfkit-train --batch 2 --epoch 2 --savedir " + MTTASK_MODEL_DIR +
            " --train " + CLAS_DATASET + " " + GEN_DATASET +
            " --lr 5e-5 --test " + CLAS_DATASET + " " + GEN_DATASET +
            " --task once clm --config voidful/albert_chinese_tiny --maxlen 50"
        )
    ...
    def testGenOnce(self):
        ...
        result = os.system(
            "tfkit-train --batch 2 --epoch 2 --savedir " + ONCE_MODEL_DIR +
            " --train " + GEN_DATASET + " --test " + GEN_DATASET +
            " --task once --config voidful/albert_chinese_tiny --maxlen 50")
        self.assertTrue(result == 0)
    ...
    def testGenOnceCTC(self):
        ...
        result = os.system(
            "tfkit-train --batch 2 --epoch 2 --savedir " + ONCE_MODEL_DIR +
            " --train " + GEN_DATASET + " --test " + GEN_DATASET +
            " --task oncectc --config voidful/albert_chinese_tiny --maxlen 50")
        self.assertTrue(result == 0)
    ...
    def testGenCLM(self):
        result = os.system(
            "tfkit-train --batch 2 --epoch 1 --savedir " + CLM_MODEL_DIR +
            " --train " + GEN_DATASET + " --test " + GEN_DATASET +
            " --task clm --config prajjwal1/bert-small --maxlen 50")
        self.assertTrue(result == 0)
        tfkit.train.main([
            "--batch",
            "2",
    ...
    def testResume(self):
        ...
        tfkit.train.main([
            ...
            "50",
            "--resume",
            os.path.join(ONCE_MODEL_DIR, "1.pt"),
        ])
