...
ADDTOK_SAVE_DIR = os.path.join(MODEL_SAVE_DIR, 'addtok/')
...
ADDTOK_MODEL_PATH = os.path.join(ADDTOK_SAVE_DIR, '2.pt')
ADDTOK_TOK_PATH = os.path.join(ADDTOK_SAVE_DIR, './voidful/albert_chinese_tiny_added_tok')
