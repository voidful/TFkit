...
class TestEval(unittest.TestCase):
    ...
    def test_parser(self):
        parser, _ = tfkit.eval.parse_eval_args([
            "--model", "once", "--metric", "emf1", "--valid", "test.csv",
            "--print"
        ])
        print(parser)
    ...
    def testEvalGen(self):
        ...
        result = os.system("tfkit-eval --model " + ONCE_MODEL_PATH +
                           " --valid " + GEN_DATASET +
                           " --metric emf1 --print")
        self.assertTrue(result == 0)
    ...
    def testEvalGenOnceCTC(self):
        ...
        result = os.system("tfkit-eval --model " + ONCECTC_MODEL_PATH +
                           " --valid " + GEN_DATASET +
                           " --metric emf1 --print")
        self.assertTrue(result == 0)
    ...
    def testEvalSeq2Seq(self):
        ...
        result = os.system("tfkit-eval --model " + SEQ2SEQ_MODEL_PATH +
                           " --valid " + GEN_DATASET +
                           " --metric emf1 --print")
        self.assertTrue(result == 0)
    ...
    def testEvalCLM(self):
        ...
        result = os.system("tfkit-eval --model " + CLM_MODEL_PATH +
                           " --valid " + GEN_DATASET +
                           " --metric emf1 --print")
        self.assertTrue(result == 0)

    def testEvalAddedTokenModel(self):
        result = os.system("tfkit-eval --model " + ADDTOKFILE_MODEL_PATH +
                           " --valid " + ADDTOK_DATASET +
                           " --metric emf1 --print")
        self.assertTrue(result == 0)
        result = os.system("tfkit-eval --model " + ADDTOKFILE_MODEL_PATH +
                           " --valid " + ADDTOK_DATASET +
                           " --metric emf1 --print")
        self.assertTrue(result == 0)
        result = os.system("tfkit-eval --model " + ADDTOKFREQ_MODEL_PATH +
                           " --valid " + ADDTOK_DATASET +
                           " --metric emf1 --print")
        self.assertTrue(result == 0)
        result = os.system("tfkit-eval --model " + ADDTOKFREQ_MODEL_PATH +
